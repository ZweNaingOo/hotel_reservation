...
/**
 * Servlet implementation class EnableCourseServlet
 */
@WebServlet("/enable_course")
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		if(request.getSession().getAttribute("isLogin")!=null) {
			if((int)request.getSession().getAttribute("userRole")!=3) {
				course_repo.enable(Integer.parseInt(request.getParameter("id")));
				request.getSession().setAttribute("result", new Result(1, "Enabled course"));
